...
The datasets that were used to evaluate and validate the SC2CD framework can be found and are freely available at: [https://doi.org/10.5281/zenodo.17601120](https://zenodo.org/records/17601120)
