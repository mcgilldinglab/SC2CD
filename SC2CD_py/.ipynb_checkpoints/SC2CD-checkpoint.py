...
class SC2CD():
    def __init__(self, 
        ...
        cell_dec : numpy array, optional
            Array representing the spot to cell estimated information returned by the other algorithm.
        ...
        if computer_adj or 'adj' not in adata.obsm.keys():
           if self.datatype in ['Stereo', 'Slide']:
              construct_interaction_KNN(self.adata)
           else:    
              construct_interaction(self.adata, self.cell_dec,self.lam, self.n_neighbors )
