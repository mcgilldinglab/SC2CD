...
def R_load(local,py):
    ...
    r_run=r('''
            ...
            source('R/measure.R')
            source('R/MuSiC-master/analysis.R')
            source('R/MuSiC-master/music2.R')
            source('R/MuSiC-master/construct.R')
            source('R/MuSiC-master/plot.R')
            source('R/MuSiC-master/simulation.R')
            source('R/MuSiC-master/utils.R')
            source('R/MuSiC-master/zzz.R')
            source('R/CARD.prop.R')
