...
# sc_countMat<-as.matrix(sc_countMat) 
...
# spatial_countMat<-as.matrix(spatial_countMat)
...
createCARDObject_imp <- function(sc_count,sc_meta,spatial_count,spatial_location_ex,ct.varname,ct.select,sample.varname,minCountGene = 100,minCountSpot =5){  
